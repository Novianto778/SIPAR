...
interface Props {
  selectedDate: Date;
  setSelectedDate: React.SetStateAction<Date>;
}
      ...
      <div className="container shadow max-w-[200px]" ref={datePickerRef}>
        <div className="relative">
          ...
          <input
            type="text"
            readOnly
            className="cursor-pointer w-full pl-4 pr-10 py-2 text-xs leading-none rounded-lg shadow-sm focus:outline-none focus:shadow-outline text-gray-600 font-medium"
          ...
          {showDatepicker && (
            <div
              className="bg-white mt-12 rounded-lg shadow p-4 absolute top-0 left-0 z-100"
              style={{ width: '17rem' }}
            >
