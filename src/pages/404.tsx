...
const NotFound = () => {
  ...
  return (
    <div className="bg-gray-100 h-screen justify-center">
      <div className="mt-24 m-auto flex flex-col items-center justify-center px-12">
        <svg
          className="emoji-404 "
      ...
      <div className="mt-6 flex justify-between">
        <button
          onClick={() => navigate(-1)}
          className="text-gray-500 font-mono text-xl bg-gray-200 p-3 rounded-md hover:shadow-md mx-auto"
        >
          Go back{' '}
        </button>
      </div>
